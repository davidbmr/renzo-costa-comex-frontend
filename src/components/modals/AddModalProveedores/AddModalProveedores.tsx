		...
		<>
			<div className={styles.filter__container}>
				...
				<TextBoxField
					...
					containerWidth="250px"
				/>
				<CustomButton text="Buscar" backgroundButton="#9B1139" colorP="white" onClick={() => ""} />
			</div>
			<br />
			<DataTable columns={columns || []} data={data} isHeaderActive={false} />
			<br />
			<CustomButton text="Enviar" backgroundButton="#9B1139" colorP="white" onClick={() => ""} />
		</>
	);
};
...
const data = [
	{ cod: "P0001", nombre: "PROVEEDOR 1", saldoCuenta: "0.00", ruc: "20999999998" },
	{ cod: "P0002", nombre: "PROVEEDOR 2", saldoCuenta: "0.00", ruc: "20799999997" },
	{ cod: "P0003", nombre: "PROVEEDOR 3", saldoCuenta: "0.00", ruc: "20699999996" },
	{ cod: "P0004", nombre: "PROVEEDOR 4", saldoCuenta: "0.00", ruc: "20599999995" },
];
